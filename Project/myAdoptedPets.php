...
<div class="inside-banner">
  <div class="container">
    <span class="pull-right"><a href="index.php">Home</a> / My Adopted Pets</span>
...
<!-- banner -->  
		...
		$sqlVariableFindMyPets = 'BEGIN :pet_variable := pet_search_package.find_myAdoptedPets(:p_search_data);END;';   
				...
				foreach($resultArray as $iterator){
					$finalResult = $finalResult.'<div class="col-lg-4 col-sm-6"> 
													<div class="properties">
														<form action="adopted-pet-detail.php" method="POST">
