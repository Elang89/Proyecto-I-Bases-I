...
<div class="inside-banner">
  <div class="container">
    <span class="pull-right"><a href="index.php">Home</a> / Manage Application Form</span>
...
<div class="">
  <div class="container">
          ...
          <div class="row">
            <div class="col-lg-12 col-sm-12">
              <div class="category-list" id = "categoryList"> 
                <form  id = "Options">  
				 <div class="col-" class="text"> Question Options </div>
				 <?php
					...
					trigger_error(htmlentities($e['message'], ENT_QUOTES), E_USER_ERROR);
							...
							oci_execute($stmt); 
								...
								while($row=oci_fetch_assoc($stmt)) { 				
									 echo "<label>{$row['QUESTION']}</label><input  type = 'radio'  name = 'radio' id = '{$row['QUESTIONID']}'  value = '{$row['QUESTION']}'/><br /> "  ; 		 
								} 				 						
				 ?>  
				</form> 
              </div>
   ...
   <script type="text/javascript">  
	function delete_Question(){   
		...
		window.location.href = "http://localhost/Proyecto-I-Bases-I/Project/deleteQuestion.php?selectedId=" + selectedId ;
	} 
		...
		window.location.href = "http://localhost/Proyecto-I-Bases-I/Project/editQuestion.php?selectedId=" + selectedId +  "&newName=" + newName;
	}  
  ...
  <form enctype="multipart/form-data" action="newQuestion.php" method="POST" class="settings-form" id="settings-form">
